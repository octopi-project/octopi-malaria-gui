...
class LiveController:
    ...
    def __init__(self,camera,microcontroller,configurationManager,parent=None,control_illumination=True,use_internal_timer_for_hardware_trigger=True,for_displacement_measurement=False):
        ...
        self.timer_trigger_interval = 1/10  # 100 fps default
        self.trigger_thread = None
        self.is_triggered_acquisition = False
    ...
    def _start_triggerred_acquisition(self):
        if not self.is_triggered_acquisition:
            self.is_triggered_acquisition = True
    ...
    def _set_trigger_fps(self,fps_trigger):
        ...
        self.timer_trigger_interval = 1 / self.fps_trigger
    ...
    def _trigger_loop(self):
        while self.is_triggered_acquisition:
            self.trigger_acquisition()
            time.sleep(self.timer_trigger_interval)
    ...
    def set_channel(self, channel):
        self.set_microscope_mode(self.microscope.configurationManager.get_configuration_by_name(channel))
...
class ConfigurationManager:
    ...
    def get_configuration_by_name(self, config_name):
        return next((config for config in self.configurations if config.name == config_name))
